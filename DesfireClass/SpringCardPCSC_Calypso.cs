...
[DllImport
     ("pcsc_calypso.dll", CharSet = CharSet.Ansi, CallingConvention =
      CallingConvention.Cdecl, EntryPoint =
      "CalypsoSetXmlOutput")] public static extern int SetXmlOutput(SCARD_CALYPSO_CTX p_ctx, ref char filename);

[DllImport
     ("pcsc_calypso.dll", CharSet = CharSet.Ansi, CallingConvention =
      CallingConvention.Cdecl, EntryPoint =
      "CalypsoSetIniOutput")] public static extern int SetIniOutput(SCARD_CALYPSO_CTX p_ctx, ref char filename);
