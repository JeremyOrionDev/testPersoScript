	...
	public abstract partial class SCARD_DESFIRE
  {
	 ...
	 */
		...
		public struct DF_VERSION_INFO
		{
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst=7, ArraySubType=UnmanagedType.U1)]
			public byte[] abUid;
			
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst=5, ArraySubType=UnmanagedType.U1)]
	 ...
	 */
		...
		[StructLayout(LayoutKind.Sequential)]
		public struct ST_DATA_FILE_SETTINGS
		{
		...
		[StructLayout(LayoutKind.Sequential)]
		public struct ST_VALUE_FILE_SETTINGS
  	{
		...
		[StructLayout(LayoutKind.Sequential)]
		public struct ST_RECORD_FILE_SETTINGS
		{
		...
		{
			[FieldOffset(0)]
			public ST_DATA_FILE_SETTINGS stDataFileSettings;
			[FieldOffset(0)]
			public ST_VALUE_FILE_SETTINGS stValueFileSettings;
			[FieldOffset(0)]
			public ST_RECORD_FILE_SETTINGS stRecordFileSettings;
		}
	...
	*/
	...
	public struct DF_ISO_APPLICATION_ST
	{
	  ...
	  public byte  bIsoNameLen;
		...
		[DllImport("pcsc_desfire.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SCardDesfire_GetErrorMessage")]
		...
		[DllImport("pcsc_desfire.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SCardDesfire_GetVersion")]
			public static extern int GetVersion(IntPtr hCard,
				ref DF_VERSION_INFO pVersionInfo);
		...
		[DllImport("pcsc_desfire.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SCardDesfire_GetFileSettings")]
			public static extern int GetFileSettings(IntPtr hCard,
				...
				ref DF_ADDITIONAL_FILE_SETTINGS additionnal_settings);
		...
		*/
		...
		[DllImport("pcsc_desfire.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SCardDesfire_GetIsoApplications")]
			public static extern int GetIsoApplications(IntPtr hCard,
				byte app_max_count,
				[In,Out, MarshalAs(UnmanagedType.LPArray,SizeParamIndex=3)] DF_ISO_APPLICATION_ST[]app_list,
				ref byte app_count);
