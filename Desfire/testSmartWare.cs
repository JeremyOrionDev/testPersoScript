//  Auteur : SOK
//  Date Début : 30.12.2013
//  Client : OL
//  Carte : Carte Desfire Test appal Ofrre
//  Dossier : 
//  Puce : Desfire 2k
//  Machine : Persoline        
//       
namespace AlanticZeiser.CpiPc.ScriptCompiler
{
    ...
    /// </summary>
    public class MyCardDesfire : CardIso14443A
    {
        ...
        #endregion
        /// <summary>
        /// Initializes a new instance of the <see cref="MyCardDesfire"/> class.
        /// </summary>
        /// <param name="readerID">The reader ID.</param>
        public MyCardDesfire(uint readerID)
            : base(readerID)
        {
        }
        /// <summary>
        ...
        {
            // select AID 0x000000
            ExchangeApdu("5A" + AID, MyCardDesfire.StatusResponseOk);
        }
        ...
        {
            ExchangeApdu("CA" + AID + KeySet1 + KeySet2, MyCardDesfire.StatusResponseOk);
        }
        ...
        {
            ExchangeApdu("CB" + FileNo + ComSet + AccessRights + FileSize, MyCardDesfire.StatusResponseOk);
        }
        ...
        public void CreateStdDataFile_AES(CardData FileNo, CardData ComSet, CardData AccessRights, CardData FileSize)
        {
            ExchangeApdu("CD" + FileNo + ComSet + AccessRights + FileSize, "00*");
        }
        public void Format_PICC()
        {
            ExchangeApdu("FC", MyCardDesfire.StatusResponseOk);
        }
        ...
        public string DESFire_ChangeKey(string keyNumber, string KeyVersion, string KeyOld, string KeyNew, int Methode, string IV)
        {
            ...
            switch (Methode)
            {
                ...
                case 4: //Change PICC Master Key to AES cas 2 Authentifier avec DESFire TDES native mode
                    ...
                    ExchangeApdu("C480" + Chaine_Crypter, MyCardDesfire.StatusResponseOk);
                    break;
                ...
                case 7: //AES mode num KeyChange == num Key Authentifier
                    ...
                    InitVector = "00000000000000000000000000000000";
                    Chaine_Crypter = AES_Enciphered_CBCMode(Chaine_A_Crypter, SessionKey, InitVector, 2);
                    ExchangeApdu("C4" + keyNumber + Chaine_Crypter, MyCardDesfire.StatusResponseOk);
                    break;
            }
            ...
            switch (Mode)
            {
                case 1: //Deciphering in receive mode
                    ...
                    for (index = 0; index < NbCrypte; index++)
                    {
                        ...
                        StatusReponse = MyCardDesfire.EncrypteDES(Text_A_Crypter, Tab_Key, 1, 1, 2);
                        if (StatusReponse == 0)
                        {
                            Tab_Xor = new byte[8];
            ...
            switch (Mode)
            {
                ...
                case 2: //Enciphering in Send mode
                    ...
                    for (index = 0; index < NbCrypte; index++)
                    {
                        ...
                        Text_A_Crypter = new byte[8];
                        Text_A_Crypter = Tab_Xor;
                        StatusReponse = MyCardDesfire.EncrypteDES(Text_A_Crypter, Tab_Key, 1, 1, 1);
                        if (StatusReponse == 0)
                        {
                            for (i = 0; i < Text_A_Crypter.Length; i++)
                            {
    ...
    public class PersoScriptGenerated : PersoScriptBase
    {
        ...
        protected override bool OnPersoCard(CardData Data)
        {
            ...
            CardData AccessRights = "12";
            CardData ReadKey1, ReadKey2, WriteKey1, WriteKey2,keyNull,AMK,MaitreApp;
          
            AMK = "9B6429EF911919A404D53D38E3BAE6B0";
            MaitreApp = "24DE17440AB75C9912D771112E6644A6";
            
            keyNull =   "00000000000000000000000000000000";
            ReadKey1 =  "A2ABFDB343E619B00BF2679BDFD6E557";
            ReadKey2 =  "E84FA4B9EF62A8FEBF9D7FF2546E8385";
            WriteKey1 = "8C898C29197C6D9EF24CE5490DD5D597";
            WriteKey2 = "E92C0D02CE64A70DB957EAD080D98CFD";
       
            // create card object (out own one)
            using (MyCardDesfire theCardObject = new MyCardDesfire(ReaderId))
            {               
                // acticate card incl. RATS (ISO 14443A level 4)
                ADF1 = theCardObject.Reset();
                theCardObject.DESFire_Authentification("0F", AMK, 3);
                theCardObject.SelectApplication("494150");
                ADF2 = theCardObject.ExchangeApdu("0x52");
                

                theCardObject.CreateApplication("495352", "0F","81");
                theCardObject.SelectApplication("495352");
                theCardObject.DESFire_Authentification("00", "0F", 3);
                
                //Create StdDataFile
                theCardObject.CreateStdDataFile_AES("01", "03", "2212", "32");
                theCardObject.CreateStdDataFile_AES("02", "03", "4434", "32");

                // Changekey en AES
                theCardObject.DESFire_ChangeKey("01", "01", "00000000000000000000000000000000", ReadKey1, 4, "");


                theCardObject.DESFire_ChangeKey("02", "01", "00000000000000000000000000000000", WriteKey1, 4, "");
