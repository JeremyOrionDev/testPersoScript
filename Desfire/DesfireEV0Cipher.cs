...
namespace SpringCard.PCSC
{
...
#if _DEBUG_CIPHER
      Console.WriteLine("CipherRecv(" + (new CardBuffer(data)).AsString() + ")");
      Console.WriteLine("Blocks : " + block_count);
#endif
...
#if _DEBUG_CIPHER
        Console.WriteLine("Block " + block + "/" + block_count + ", IV=" + (new CardBuffer(IV)).AsString() + ", C=" + (new CardBuffer(t)).AsString());
#endif

        core.Encrypt(ref t);
				  
#if _DEBUG_CIPHER
        Console.WriteLine("\t   " + (new CardBuffer(t)).AsString());
#endif
...
#if _DEBUG_CIPHER
        Console.WriteLine("\t--> " + (new CardBuffer(data, 8 * block, 8)).AsString());
#endif
			}
...
#if _DEBUG_CIPHER
      Console.WriteLine("CipherSend(" + (new CardBuffer(data)).AsString() + ")");
#endif
...
#if _DEBUG_CIPHER
      Console.WriteLine("           " + (new CardBuffer(data)).AsString());
      Console.WriteLine("Blocks : " + block_count);
#endif
			...
			{
#if _DEBUG_CIPHER
        Console.Write("Block " + block + "/" + block_count + ", IV=" + (new CardBuffer(IV)).AsString() + ", P=" + (new CardBuffer(data, 8 * block, 8)).AsString());
#endif
...
#if _DEBUG_CIPHER
        Console.Write(" -> " + (new CardBuffer(t)).AsString());
#endif
...
#if _DEBUG_CIPHER
        Console.WriteLine(", C=" + (new CardBuffer(data, 8 * block, 8)).AsString());
#endif
			}
    ...
    static bool do_des_test(string key, string plain, string cipher)
    {
      ...
      Console.WriteLine(key + "," + plain + "," + cipher);
      ...
      Console.WriteLine((new CardBuffer(b)).AsString());
      Console.WriteLine((new CardBuffer(c)).AsString());
      ...
      Console.WriteLine((new CardBuffer(b)).AsString());
      Console.WriteLine((new CardBuffer(p)).AsString());
...
#if _DEBUG_MAC
      Console.WriteLine("MAC(" + (new CardBuffer(data)).AsString() + ")");
#endif
...
#if _DEBUG_MAC
      Console.WriteLine("    " + (new CardBuffer(buffer)).AsString());
#endif
