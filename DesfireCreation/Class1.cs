...
namespace Desfire
{
    class Class1
    {
        ...
        public class MyCardDesfire : CardIso14443A
        {
            ...
            public new CardData ExchangeApdu(CardData cmd)
            {
                CardData response;
                response = ExchangeApdu(cmd);
                return response;
            }
            /// <summary>
            ...
            public string DESFire_ChangeKey(string keyNumber, string KeyVersion, string KeyOld, string KeyNew, int Methode, string IV)
            {
                ...
                switch (Methode)
                {
                    ...
                    case 2: //DESFire Native TDES mode n� KeyNum == n� Key Authentifier
                        ...
                        ExchangeApdu("C400" + Chaine_Crypter, MyCardDesfire.StatusResponseOk);
                        break;
        ...
        public class PersoScriptGenerated : PersoScriptBase
        {
            ...
            protected override bool OnPersoCard(CardData Data)
            {
                ...
                using (MyCardDesfire theCardObject = new MyCardDesfire(ReaderId))
                {
                    ...
                    CardData keyRead1, keyRead2, keyWrite1, keyWrite2, AMK, MasterCard, keyNull;
                    AMK = "9B6429EF911919A404D53D38E3BAE6B0";
                    MasterCard = "24DE17440AB75C9912D771112E6644A6";
                    keyNull = "00000000000000000000000000000000";
                    keyRead1 = "A2ABFDB343E619B00BF2679BDFD6E557";
                    keyRead2 = "E84FA4B9EF62A8FEBF9D7FF2546E8385";
                    keyWrite1 = "8C898C29197C6D9EF24CE5490DD5D597";
                    keyWrite2 = "E92C0D02CE64A70DB957EAD080D98CFD";

                    // acticate card incl. RATS (ISO 14443A level 4)
                    ADF1 = theCardObject.Reset();

                    ADF2 = theCardObject.Uid;
                    ADF3 = theCardObject.ExchangeApdu("52");
                    ADF4 = theCardObject.ExchangeApdu("6A");

                    //Create Application 7 : 495352
                    ...
                    //authenticate
                    theCardObject.DESFire_Authentification("00", keyNull, 3);
                    //create StddataFile
                    theCardObject.CreateStdDataFile("00", "00", "2212", "500000");
                    theCardObject.CreateStdDataFile("01", "00", "4434", "500000");

                    //CHANGE KEY
                    theCardObject.DESFire_Authentification("00", keyNull, 3);
                    theCardObject.DESFire_ChangeKey("01", "00", keyNull, keyRead1, 6, "");
                    theCardObject.DESFire_ChangeKey("02", "00", keyNull, keyWrite1, 6, theCardObject.CurrentIV);
                    theCardObject.DESFire_ChangeKey("03", "00", keyNull, keyRead2, 6, "");
                    theCardObject.DESFire_ChangeKey("04", "00", keyNull, keyWrite2, 6, theCardObject.CurrentIV);
